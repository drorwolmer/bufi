...
var CREDENTIALS = JSON.parse(fs.readFileSync("./creds.json", "utf8"));
...
app.get("/budget", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var r;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, SHEETS.spreadsheets.values.get({
...
app.post("/expense", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var expense, r;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, SHEETS.spreadsheets.values.append({
                        ...
                        requestBody: {
                            ...
                            values: [
                                [
                                    (0, moment_1.default)(expense.date, "YYYY-MM-DD").format("DD/MM/YYYY"),
                                    expense.category,
                                    expense.amount,
                                    expense.who,
                                    expense.what,
